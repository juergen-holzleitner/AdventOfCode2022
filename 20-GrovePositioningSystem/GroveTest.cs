...
namespace _20_GrovePositioningSystem
{
  public class GroveTest
  {
    ...
    {
      var inputData = "1\r\n2\r\n-3\r\n3\r\n-2\r\n0\r\n4\r\n";
      var input = Grove.ParseInput(inputData);
    ...
    [Theory]
    [InlineData(1, new[] { 2, 1, -3, 3, -2, 0, 4 })]
    [InlineData(2, new[] { 1, -3, 2, 3, -2, 0, 4 })]
    [InlineData(3, new[] { 4, 1, 2, 3, -2, -3, 0 })]
    public void Can_move_elements_for_n_steps(int numSteps, int[] expectedElements)
    {
      var inputData = "1\r\n2\r\n-3\r\n3\r\n-2\r\n0\r\n4\r\n";

      var elements = Grove.MoveAllElementsForNSteps(inputData, numSteps);
    ...
    public void Can_move_all_elements()
    {
      ...
      var elements = Grove.MoveAllElements(inputData);
    ...
    public void Can_get_grove_coordinate()
    {
      ...
      var groveCoordinate = Grove.GetGroveCoordinate(inputData);
