...
namespace _11_Monkey
{
  public class MonkeyTest
  {
    ...
    public void Can_parse_starting_items()
    {
      ...
      item.Should().BeEquivalentTo(new StartingItem(new List<int> { 79, 98 }));
    }
    ...
    public void Can_parse_monkeys()
    {
      ...
      monkeys[0].StartingItem.Should().BeEquivalentTo(new StartingItem(new List<int> { 79, 98 }));
      for (int n = 10; n < 20; ++n)
      {
    ...
    public void Can_parse_test_input()
    {
      ...
      monkeys[3].StartingItem.Should().BeEquivalentTo(new StartingItem(new List<int> { 74 }));
      for (int n = 10; n < 20; ++n)
      {
    ...
    public void Can_process_round()
    {
      ...
      MonkeyStuff.ProcessRound(monkeys);

      monkeys[0].StartingItem.Should().BeEquivalentTo(new StartingItem(new List<int> { 20, 23, 27, 26 }));
      monkeys[1].StartingItem.Should().BeEquivalentTo(new StartingItem(new List<int> { 2080, 25, 167, 207, 401, 1046 }));
    ...
    public void Can_process_multiple_rounds()
    {
      ...
      monkeys[0].StartingItem.Should().BeEquivalentTo(new StartingItem(new List<int> { 10, 12, 14, 26, 34 }));
      monkeys[1].StartingItem.Should().BeEquivalentTo(new StartingItem(new List<int> { 245, 93, 53, 199, 115 }));
      monkeys[2].StartingItem!.Items.Should().BeEmpty();
      monkeys[3].StartingItem!.Items.Should().BeEmpty();
    }
